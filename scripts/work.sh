...
CUDA_VISIBLE_DEVICES=3,4,5,6 sh scripts/work.mt.sh $ckpt facebook/mbart-large-50-many-to-many-mmt

ckpt=/apdcephfs/share_916081/jcykcai/nonono/mbart50/runs/0/best-smatch_checkpoint_7_0.8271.pt
CUDA_VISIBLE_DEVICES=3,4,5,6 sh scripts/work.mt.sh $ckpt facebook/mbart-large-50

ckpt=/apdcephfs/share_916081/jcykcai/nonono/bart/runs/0/best-smatch_checkpoint_5_0.8441.pt
CUDA_VISIBLE_DEVICES=3,4,5,6 sh scripts/work.mt.sh $ckpt facebook/bart-large

...
if __name__=="__main__":
    ...
    #    lang_sentences=[]
    #    with open(translations + "_{}.txt".format(lang.lower()),"r", encoding='utf-8') as infile:
    #        for line in infile:
    ...
    for lang in ["ES","DE", "IT", "ZH"]:
        ...
        for ann in file_list:
            with open(translations+"amr-release-2.0-amrs-test-{}.sentences.{}.txt".format(ann, lang), "r", encoding='utf-8') as infile:
                for line in infile:
                    lang_sentences.append(line.rstrip())
